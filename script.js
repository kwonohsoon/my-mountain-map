 ...
 const mountains = [
  {
    ...
    photo: "images/01.jpg",
    date: "2018-05-20",
    note: "은혜 갚은 까치의 전설이 있는 곳 치악산, 단풍이 아름다워 적악산이라 불렀다가, 은혜 갚은 까지의 전설로 치악산이라 불리기 시작했다
            첫 100명산 도전이며 친구 법모랑 함께 등반 했다. 여러가지 등산코스가 있지만 구룡사 쪽에서 등산을 시작한다면 계곡 쪽을 추천하고 
            싶은데 그 이유는 자연경관을 잘 유지하며 산행하는 느낌을 받을 수 있고 하산시에는 수려한 경관을 내려다 볼 수 있는 사다리병창길을
            추천한다"
  },
  {
    name: "주흘산",
    ...
    photo: "images/02.jpg",
    date: "2018-06-30",
    note: "소백산맥의 중심 주흘산을 담다. 주흘산은 조령산, 포암산, 월악산 등과 더불어 소백산맥의 중심을 이루며 높이 1108.4m로 산세가 
            아름답고 문경새제 등의 역사적 전설이 담긴 곳. 주흘산 주봉 법모랑 같이 갔는데 많이 힘들어 함"
  },
  {
    name: "청량산",
    lat: 36.794336,
  ...
  },
  {
    ...
    photo: "images/07.jpg",
    date: "2018-09-03",
    note: "겨울에 오대산 능선에 오르면 멋스러운 전나무와 고사목, 아름다운 설경 등이 어우러져 겨울산의
            신비로움을 느낄 수 있다고 한가 9월에 왔는데 비가 많이 와서 산행에 어려움이 있었고 
            암자에서 배가 고파 눈치없게 떡을 많이 먹었다.ㅋ"
  },
  {
    name: "오대산 노인봉",
    lat: 37.78251,
